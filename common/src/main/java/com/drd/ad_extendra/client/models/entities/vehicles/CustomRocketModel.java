...
public class CustomRocketModel<T extends CustomRocket> extends RocketModel<T> {
    ...
    public static final ModelLayerLocation TIER_12_LAYER = new ModelLayerLocation(new ResourceLocation(AdExtendra.MOD_ID, "tier_12_rocket"), "main");
    ...
    @SuppressWarnings({"unused", "DuplicatedCode"})
    public static LayerDefinition createTier12Layer() {
        MeshDefinition meshdefinition = new MeshDefinition();
        PartDefinition partdefinition = meshdefinition.getRoot();

        PartDefinition rocket12 = partdefinition.addOrReplaceChild("main", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition body = rocket12.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offset(-8.0F, -23.0F, -8.0F));
        ...
        PartDefinition middle_rod = pyramid_holder.addOrReplaceChild("middle_rod", CubeListBuilder.create().texOffs(72, 0).addBox(7.0F, -142.5F, 7.0F, 2.0F, 27.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(216, 47).addBox(3.0F, -152.25F, 3.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F))
                .texOffs(104, 0).addBox(6.0F, -117.25F, 6.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(104, 0).addBox(6.0F, -120.25F, 6.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(104, 0).addBox(6.0F, -123.25F, 6.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(104, 0).addBox(6.0F, -126.25F, 6.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition engine = rocket12.addOrReplaceChild("engine", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    public static void register(ClientPlatformUtils.LayerDefinitionRegistry registry) {
        ...
        registry.register(TIER_12_LAYER, CustomRocketModel::createTier12Layer);
    }
}
