package com.drd.ad_extendra.client.models.entities.mobs;

import com.drd.ad_extendra.client.util.ModAnimationDefinitions;
...
public class FreezeModel<T extends Entity> extends HierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AdExtendra.MOD_ID, "freeze"), "main");
