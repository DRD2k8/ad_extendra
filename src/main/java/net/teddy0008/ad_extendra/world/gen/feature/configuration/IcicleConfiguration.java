package net.teddy0008.ad_extendra.world.gen.feature.configuration;
...
public class IcicleConfiguration implements FeatureConfiguration {
    public static final Codec<IcicleConfiguration> CODEC = RecordCodecBuilder.create((p_191286_) -> {
        ...
        })).apply(p_191286_, IcicleConfiguration::new);
    });
    ...
    public IcicleConfiguration(float p_191281_, float p_191282_, float p_191283_, float p_191284_, BlockStateProvider block, BlockStateProvider block2)   {
